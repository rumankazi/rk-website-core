...
export default defineConfig({
  ...
  description: 'Complete TypeScript/Next.js development documentation with DevOps automation',
  ...
  themeConfig: {
      ...
      '/architecture/': [
        {
          ...
          items: [
            ...
            { text: 'Monitoring & Observability', link: '/architecture/monitoring' }
          ]
        }
      ],
      '/api/': [
      ...
      '/infrastructure/': [
        {
          ...
          items: [
            ...
            { text: 'Cloud Resources', link: '/infrastructure/cloud-resources' }
          ]
        }
      ]
    },
    ...
    // Edit link
    editLink: {
      pattern: 'https://github.com/rumankazi/rk-website-core/edit/main/docs/:path',
  ...
  head: [
    ...
    ['meta', { name: 'description', content: 'Complete TypeScript/Next.js development documentation with DevOps automation' }]
  ],
